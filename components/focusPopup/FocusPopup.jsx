		...
		<div className={styles.focusPopupContainer}>
			<div className={styles.focusPopupContentContainer}>
				<div className={styles.focusPopupContent}>
					<h1>הכנס לפלואו</h1>
					<p>
						מצב זרימה (באנגלית: Flow state) מתרחש כאשר אתה שקוע במה שאתה עושה, המחשבות
						זורמות בקלות ונראה שהכל מתחבר יחד. כדי להגיע לשם, תצטרך להפטר מחסמים מנטליים
						וביקורתיות כלפי העבודה שלך. כדי לעזור לך, נגדיר פרק זמן של כמה דקות שבמהלכם
						תהיה מוכרח לכתוב — אחרת, אם תחדל ליותר מכמה שניות, כל מה שכתבת ימחק. זה
						מפחיד, מסוכן, אך גם הוכח כאפקטיבי בצורה יוצאת דופן.
					</p>
					<form>
						<div className={styles.focusPopupTimeContainer}>
							...
							<div className={styles.focusPopupTimeInputContainer}>
								<input
									...
									min="1"
									max="120"
									className={styles.focusPopupTimeInput}
									value="5"
								/>
